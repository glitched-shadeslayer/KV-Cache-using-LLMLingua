...
def compress_with_llmlingua(context, question, ratio=0.5, dynamic_context_compression_ratio=0.3):
    ...
    compressed_context = compressor.compress_prompt(context,  question, rate=ratio, dynamic_context_compression_ratio = dynamic_context_compression_ratio)#, device=device)
